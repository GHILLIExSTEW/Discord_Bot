...
def build_pdf():
    ...
    story += section("🧪", "Testing without recording", "When <b>TESTING=1</b>, upload an image in <b>TEST_CHANNEL_ID</b>. The bot parses the image and shows the result without writing to the database, posting a bet, or requiring confirmation. Use <b>Enter units</b> if the caption/image does not show units, then <b>Complete test</b>. Set <b>TESTING=0</b> to disable this channel." )
